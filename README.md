...
- [harness-engineering-curriculum.html](./harness-engineering-curriculum.html) - compatibility redirect for older links.
...
- Keep curriculum content in `index.html` only; do not duplicate it into the compatibility redirect.
